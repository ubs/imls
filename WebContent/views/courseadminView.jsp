...
<%
	...
	if (viewParams != null){
		Info.sout("In courseadminView.jsp View Params Keys: " + viewParams.getAllParameterKeys());
	}
	...
	if (viewParams != null){
		...
		areaFieldsExist = Boolean.valueOf(
				viewParams.getParameter(ParameterNames.PN_AREA_FIELDS_EXIST).toString() );
	}
