		...
		<div style="margin-bottom: 10px;">
			<div>
				...
				<div style="line-height: 20px;">
					Your assessed Competency Level is <span style="font-weight:bold;"><%= parAssessedCompetencyLevel %></span>
				</div>
				
				<div style="line-height: 20px;">
					Course Modules matching your assessed competency level have also been assigned to you.
					<span style="margin-left: 10px;">
						<a href="<%= LinksManager.COURSE_MODULES %>" title="Click to start studying now!">&raquo; Start Studying</a>
					</span>
				</div>
			</div>
		</div>
