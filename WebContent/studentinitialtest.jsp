...
<%
	...
	String flashInfo = "";
	String viewPage = "studentinitialtestView.jsp";
	...
	if ((currentUser == null) || (student == null) || (areaField == null)) {
		flashInfo = "Sorry, competency test cannot be started at the moment. please try again later. ";
	...
	if (parFlowControlParam == null){
		...
		if (assessmentQuestions.size() > 0) {
			...
			flashInfo = "Sorry, competency test cannot be done. No assessment questions found for " + parAreaFieldName;
			SessionManager.setFlashInfo(session, flashInfo, FlashInfoType.WARNING);
		}
	}
		...
		//Assign Courses, Let Agent do this too
		//TODO TODO
		boolean pss = StudentStudyRecord.AssignCourseModulesToStudentBasedOnScore(currentUser, parAssessedCompetencyLevel);
