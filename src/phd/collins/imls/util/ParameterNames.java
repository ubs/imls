...
public interface ParameterNames {
	public static final String PN_APP_INIT_ALREADY_DONE = "PN_APP_INIT_ALREADY_DONE";
	public static final String PN_APP_INIT_RESPONSE 	= "PN_APP_INIT_RESPONSE";
	public static final String PN_APP_INIT_ADMIN_USER 	= "PN_APP_INIT_ADMIN_USER";
	...
	public static final String PN_REG_NUMBER = "regnumber";
	public static final String PN_STUDENT_NAME = "studentname";
