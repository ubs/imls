...
import phd.collins.imls.agents.ontologies.AssessmentOntology;
import phd.collins.imls.agents.vocabularies.IMLSAgentsVocabulary;
import phd.collins.imls.util.Info;

public class AssessmentAgent extends Agent implements IMLSAgentsVocabulary {

	private static final long serialVersionUID = 2618593027961749935L;
	...
	protected void setup() {
		...
		//Get Ontology
		imlsOntology = AssessmentOntology.getInstance();
		...
		serviceDesc.setType(ASSESSMENT_AGENT);
		serviceDesc.setOwnership(ASSESSMENT_AGENT_OWNER);
		...
		// Service name
		String wsigServiceName = ASSESSMENT_AGENT_BASENAME + ((int)(Math.random() * 100) + 1);
		...
		//Add Behaviour
		this.addBehaviour( new CyclicAuthenticationBehaviour() ); //TODO
	}
