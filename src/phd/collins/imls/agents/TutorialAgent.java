...
import phd.collins.imls.agents.ontologies.TutorialOntology;
import phd.collins.imls.agents.vocabularies.IMLSAgentsVocabulary;
import phd.collins.imls.util.Info;

public class TutorialAgent extends Agent implements IMLSAgentsVocabulary {

	private static final long serialVersionUID = -1497854169128352384L;
	...
	protected void setup() {
		...
		//Get Ontology
		imlsOntology = TutorialOntology.getInstance();
		...
		serviceDesc.setType(TUTORIAL_AGENT);
		serviceDesc.setOwnership(TUTORIAL_AGENT_OWNER);
		...
		// Service name
		String wsigServiceName = TUTORIAL_AGENT_BASENAME + ((int)(Math.random() * 100) + 1);
